	...
	$(document).ready(function(){
		...
		var data = {
			...
			edges: [
				 ...
				 {src: 'Дарья Вейдер-Авалон', dest: "Варя Вилюжанина"},
				 {src: 'Илья Катц', dest: "Влад Лободов"},
				 ...
				 {src: 'Илья Наговитчин', dest: "Дарья Вейдер-Авалон"},
				 {src: 'Черных', dest: "Влад Лободов"},
				 {src: 'Влад Бусов', dest: "Илья Катц"},
